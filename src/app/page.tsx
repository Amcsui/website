    ...
    <main className="flex flex-col max-w-[54rem] w-full gap-[5rem]">
      <header className="flex flex-col lg:flex-row items-center justify-between gap-4 md:gap-8 lg:gap-14">
        <h1 className="text-display-md text-center lg:text-right md:text-display-md lg:text-display-lg font-lalezar">
          <span>انجمن علمی </span>
          <span className="text-tertiary">(ری)اضی</span>
          <span> و </span>
          <span className="text-primary">علوم (کا)مپیوتر</span>
        </h1>
      ...
      <div className="flex flex-col gap-6 lg:gap-16">
        ...
        <div className="justify-center items-center gap-9 relative hidden lg:flex">
          ...
          <div className="flex flex-col bg-[#e2d9f3] px-4 py-2 rounded absolute w-[360px] -top-4 left-11 pr-14">
            ...
            <div className="text-body-sm">
              تدریس انواع حیطه‌های علمی و تخصصی؛ مشاوره‌ی علمی و آموزشی؛
              نویسندگی در حوضه‌های ذکر شده
            </div>
          </div>
          <div className="flex flex-col bg-[#e2d9f3] px-4 py-2 rounded absolute w-[360px]  -left-9 pr-14">
            <div className="size-20 bg-background absolute -right-8 top-1 rounded-full"></div>
            <div className="font-lalezar">تدارکات و اجرا</div>
            <div className="text-body-sm">
              بازو‌های اجرایی؛ تعیین، ‌تامین و پیگیری دریافت تدارکات؛ مدیریت
              منابع مالی و دارایی‌های انجمن
            </div>
          </div>
          <div className="flex flex-col bg-[#e2d9f3] px-4 py-2 rounded absolute w-[360px] -bottom-2 left-10 pr-14">
            ...
            <div className="text-body-sm">
              روابط عمومی با خارج از انجمن؛ جذب و توانمند‌سازی اعضا؛‌ گزارش
              نویسی؛‌ مدیریت شبکه‌های اجتماعی
            </div>
          </div>
          <div className="flex flex-col bg-[#e2d9f3] px-4 py-2 rounded absolute w-[360px] bottom-2 -right-4 pl-14">
            ...
            <div className="text-body-sm">
              تولید و ادیت محتوای متنی، گرافیکی، ویدیوئی و صوتی؛ تامین محتوای
              هنری (نقاشی، ساز و ... )
            </div>
          </div>
          <div className="flex flex-col bg-[#e2d9f3] px-4 py-2 rounded absolute w-[360px] top-9 -right-8 pl-14">
            ...
            <div className="text-body-sm">
              مهندسی نرم‌افزار و داده؛ توسعه وب (توسعه بک‌اند و فرانت‌اند)؛‌
              آی‌تی؛‌ باقی مهارت‌های کامپیوتری
            </div>
          </div>
        </div>
        <div className="gap-x-3 gap-y-12 grid grid-cols-2 lg:hidden">
          ...
          <div className="bg-primary-container rounded-lg flex flex-col gap-2 px-3 pb-4 pt-12 relative">
            ...
            <div className="font-lalezar text-center text-lg">
              آموزش و مشاوره
            </div>
            <div className="text-body-sm text-center text-pretty">
              تدریس انواع حیطه‌های علمی و تخصصی؛ مشاوره‌ی علمی و آموزشی؛
              نویسندگی در حوضه‌های ذکر شده
            </div>
          </div>
      ...
      <div className="flex flex-col gap-3">
        ...
        <div className="flex gap-4 flex-wrap">
          <ClubCard title="بوک کلاب" img="/book-club.jpeg">
            در بوک کلاب ریکا، ما یک جمع دوستانه هستیم که با هدف ترویج
            کتاب‌خوانی، کتاب‌هایی با موضوعات علمی و یا داستانی با پیشنهاد و
            معرفی خود اعضا مطالعه می‌کنیم و از هر منظری بحث و تحلیل می‌کنیم.
            <br />
            اینجا حتی اگر کتابی را مطالعه نکرده‌اید اما به آن علاقه‌مندید،
            می‌توانید برای مشاهده ارائه دیگران و شرکت در بحث به ما بپیوندید.
          </ClubCard>
          <ClubCard title="دیسکاشن کلاب" img="/discussion-club.jpeg">
            در دیسکاشن کلاب ریکا، ما با جمعی دانشجویی و دوستانه تلاش می‌کنیم
            بدون هیچ هزینه‌ای سطح زبان هم رو تقویت کنیم!
            <br />
            اینجا فضاییه که تمامی علاقه‌مندان زبان و مباحثه، از هر سطح زبان، هر
            هفته دور هم جمع شده و درباره موضوعات مختلف و پیشنهادی هم، به زبان
            انگلیسی گفت‌وگو می‌کنیم تا ارتباط بگیریم و برای یادگیری هم رو به
            چالش بکشیم.
          </ClubCard>
        </div>
      </div>
      ...
      <div className="flex flex-col gap-4">
        ...
        <div className="flex flex-wrap gap-x-4 gap-y-2">
          <SocialLink
            href="http://telegram.me/AMCSUI"
            title="کانال تلگرام اصلی"
            img={Telegram}
          />
          <SocialLink
            href="https://www.linkedin.com/company/amcsui"
            title="صفحه لینکدین"
            img={LinkedIn}
          />
          <SocialLink
            href="https://www.instagram.com/amcsui/"
            title="صفحه اینستاگرام"
            img={Instagram}
          />
          <SocialLink
            href="http://telegram.me/AMCSUIClubs"
            title="کانال تلگرام کلاب‌ها"
            img={Telegram}
          />
          <SocialLink
            href="https://t.me/AMCSUIChat"
            title="گروه تلگرام همکاری"
            img={Telegram}
          />
          <SocialLink
            href="http://telegram.me/AMCSSup"
            title="گروه تلگرام پشتیبانی"
            img={Telegram}
          />
        </div>
      </div>
      <div className="text-body-sm">
        <hr className="mb-6" />
        <a
          className="flex gap-2 text-primary mb-2"
...
const SocialLink = ({
  ...
  return (
    <a
      href={href}
      className="flex basis-[100%] md:basis-[30%] gap-2 items-center rounded-lg border border-outline py-2 pl-4 pr-3"
    >
...
const ClubCard = ({
  ...
  return (
    <div className="flex flex-col md:flex-row max-w-[28rem] md:max-w-[45rem] m-auto gap-4 md:gap-8 py-4 px-6 rounded border shadow-sm">
      <img
        src={img}
      ...
      <img
        src={img}
        className="rounded block md:hidden mx-auto"
        alt={title}
        width={240}
        height={320}
      />
      <div className="flex flex-col gap-1">
        <div className="text-head-xs font-lalezar text-center md:text-right">
          {title}
        </div>
